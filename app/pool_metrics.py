class PoolMetrics:
    ...
    def getTransientValidators(self):
        ...
        # assert self.depositedValidators + self.preDepositValidators >= self.beaconValidators
        return self.depositedValidators + self.preDepositValidators - self.beaconValidators
